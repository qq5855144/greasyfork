...
const domHandler = {
    ...
    injectStyle() {
        ...
        cssNode.textContent = `
            ...
            .${CLASS_NAMES.ENGINE_CONTAINER}.input-focused {
                /* 输入框聚焦时的特殊样式 */
                bottom: ${utils.getEngineBarOffset()}px;
            }
    ...
    initTouchScrollProtection() {
        ...
        // 监听输入框聚焦状态
        const updateInputFocusState = (focused) => {
    ...
    updateSearchBoxPosition() {
        ...
        // 判断是否需要应用偏移（输入框聚焦时）
        const focusedInput = document.activeElement;
        const shouldOffset = focusedInput && focusedInput.matches('input, textarea');
