...
const mobileAdapter = {
    ...
    initViewportListener() {
        ...
        if (visualViewport) {
            ...
            visualViewport.addEventListener('scroll', this.handleViewportScroll.bind(this));
        }
    ...
    handleWindowResize() {
        // 延迟执行，避免频繁触发
        debounceUtils.debounce('window_resize', () => {
            const windowHeight = window.innerHeight;
            const initialHeight = appState.initialWindowHeight || window.screen.height;
            
            // 计算可能的键盘高度
            const keyboardHeight = Math.max(0, initialHeight - windowHeight);
    ...
    keepInViewport() {
        ...
        if (searchBoxRect.bottom > viewportBottom) {
            ...
            searchBox.style.bottom = `${parseInt(searchBox.style.bottom || 0) + offset}px`;
        }
    },
    ...
    showKeyboardSettings() {
            ...
            <div style="padding: 20px; max-width: 300px;">
                ...
                <div style="background: #f8f9fa; padding: 10px; border-radius: 5px; margin-bottom: 15px;">
                    <div style="font-size: 12px; color: #666;">
                        ...
                        设备: ${keyboardStatus.isMobile ? '移动端' : '桌面端'}<br>
                        键盘: ${keyboardStatus.visible ? '显示' : '隐藏'}<br>
                        高度: ${keyboardStatus.height}px
                    </div>
                </div>
        ...
        searchOverlay.showCustomPanel('键盘设置', settingsHtml, () => {
            ...
            if (offsetInput && offsetValue) {
                ...
                const saveBtn = document.getElementById('save-keyboard-settings');
                const resetBtn = document.getElementById('reset-keyboard-settings');
