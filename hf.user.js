...
const utils = {
    ...
    detectInputMethodState() {
        ...
        appState.keyboardVisible = isKeyboardByViewport || isKeyboardByPosition;
    ...
    startInputMethodMonitoring() {
        ...
        appState.inputMethodCheckInterval = setInterval(() => {
            this.detectInputMethodState();
        }, DEFAULT_CONFIG.INPUT_METHOD_CHECK_INTERVAL);
    },
