...
` },
    { name: "百度", searchUrl: "https://www.baidu.com/s?wd={keyword}", searchkeyName: ["wd", "word"], matchUrl: /baidu\.com.*?w(or)?d=?/g, mark: "Baidu", svgCode: `<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">
<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="240px" height="149px" viewBox="0 0 240 149" enable-background="new 0 0 240 149" xml:space="preserve">  <image id="image0" width="240" height="149" x="0" y="0"
    xlink:href="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAPAAAACVCAYAAABmbHd7AAAAIGNIUk0AAHomAACAhAAA+gAAAIDo
...
mark: "iconfont",
svgCode: `
<svg class="icon" style="width: 1em;height: 1em;vertical-align: middle;fill: currentColor;overflow: hidden;" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="15274"><path d="M731.733333 256m-85.333333 0a85.333333 85.333333 0 1 0 170.666667 0 85.333333 85.333333 0 1 0-170.666667 0Z" fill="#FF354A" p-id="15275"></path><path d="M343.466667 386.133333L140.8 718.933333c-34.133333 57.6 6.4 130.133333 72.533333 130.133334h407.466667c66.133333 0 106.666667-72.533333 72.533333-130.133334L490.666667 386.133333c-34.133333-53.333333-113.066667-53.333333-147.2 0z" fill="#2953FF" p-id="15276"></path><path d="M631.466667 548.266667l-106.666667 174.933333C490.666667 780.8 531.2 853.333333 597.333333 853.333333h213.333334c66.133333 0 106.666667-72.533333 72.533333-130.133333l-106.666667-174.933333c-32-55.466667-113.066667-55.466667-145.066666 0z" fill="#FCCA1E" p-id="15277"></path></svg>
`},
...
{ name: "天眼查", searchUrl: "https://www.tianyancha.com/search?key={keyword}", searchkeyName: ["key"], matchUrl: /tianyancha\.com.*?key=/g, mark: "Tianyancha", svgCode: `<svg xmlns="http://www.w3.org/2000/svg" width="120" height="120" viewBox="0 0 48 48"><path fill="none" stroke="#65a30d" stroke-linecap="round" stroke-linejoin="round" d="M45.338 21.366Q45.5 22.669 45.5 24h0c0 3.843-1.008 7.45-2.775 10.573c-7.823 2.36-14.597-3.564-15.458-6.55c1.74 6.488 18.504 2.553 18.071-6.657"/><path fill="none" stroke="#65a30d" stroke-linecap="round" stroke-linejoin="round" d="M40.533 37.745A21.5 21.5 0 0 1 29.39 44.82c-4.747-6.902-6.165-13.963-4.786-20.64c-1.556 4.226 3.6 16.376 15.929 13.566"/><path fill="none" stroke="#65a30d" stroke-linecap="round" stroke-linejoin="round" d="M26.809 45.318q-1.38.181-2.809.182c-6.638 0-12.573-3.008-16.517-7.736c2.876-8.695 10.38-17.557 19.092-21.63c-6.71 4.952-8.028 21.665.234 29.184"/><path fill="none" stroke="#65a30d" stroke-linecap="round" stroke-linejoin="round" d="M40.979 20.267c6.795-8.95-5.676-18.34-26.84-8.32c3.018-5.138 14.936-8.7 22.07-5.675C32.604 3.76 28.403 2.5 24 2.5C12.126 2.5 2.5 12.126 2.5 24c0 4.134 1.167 7.996 3.203 11.275c3.971-10.7 9.82-16.048 16.272-19.84c7.492-4.403 22.148-4.514 19.004 4.832"/></svg>` },
  {
    name: "Ecosia",
    ...
    mark: "Ecosia",
    svgCode: `
      <svg xmlns="http://www.w3.org/2000/svg" width="120" height="120" viewBox="0 0 24 24"><path fill="#dc2626" d="M15.198 6.818H8.786v10.48h6.412v-3.342h-3.98v-1.262H13.8V11.42h-2.584v-1.261h3.981zM11.972.06A12.003 12.003 0 0 0 0 12.064a12 12 0 0 0 10.083 11.848c.068-1.277.196-2.723.434-3.652v-.014c0-.005 0-.007-.01-.012c0-.005-.01-.007-.012-.009c0-.002-.01-.002-.014-.002h-.356c-2.307 0-5.943-.333-6.916-3.45c-1.458-4.642 2.025-6.314 3.484-4.97c0 .004.012.008.019.008q.013.001.02-.005q.014-.007.015-.016v-.021c-.322-.945-2.148-6.867 2.64-8.496c4.08-1.369 8.07 1.491 7.461 5.265v.017c0 .007.01.012.012.014c0 .002.012.005.016.005c0 0 .012-.002.016-.005c.298-.246 1.603-1.186 2.919-.148c1.247.982.844 3.73-1.627 5.003q-.013.003-.02.014v.023c0 .01.01.014.015.02q.014.006.023.001c1.596-.239 4.316 1.193 2.11 4.375c-1.447 2.1-4.71 2.365-6.168 2.365h-1.071s-.01 0-.012.002c0 .002-.01.005-.012.007c0 .002 0 .005-.01.009v.012c-.021.751.331 2.304.693 3.688A12 12 0 0 0 24 12.063A12.003 12.003 0 0 0 11.997.06h-.03z"/></svg>
    `
  },
];
